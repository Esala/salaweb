  ...
  render() {
    ...
    return (
      <div className="mercadon">
        ...
        <ProjectStructure title="El Mercadón" color="#1C42A1" description="Nov 2017. Branding. Product design. Web / UI design. E-commerce." light next="/projects/psychopharmacology-institute" >
